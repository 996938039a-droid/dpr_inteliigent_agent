...
class ReviewHandler:
    ...
    def build_review_screen(self, store: SessionStore, benchmarks: dict) -> str:
        ...
        from agents.validators import quick_dscr_estimate
        ...
        if dscr_result:
            ...
            from agents.validators import estimate_bep_utilization
            from agents.benchmark_engine import FALLBACK_BENCHMARKS
